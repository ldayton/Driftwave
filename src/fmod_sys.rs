...
pub const FMOD_SOUNDGROUP_BEHAVIOR_FMOD_SOUNDGROUP_BEHAVIOR_STEALLOWEST: FMOD_SOUNDGROUP_BEHAVIOR = 2;
pub const FMOD_SOUNDGROUP_BEHAVIOR_FMOD_SOUNDGROUP_BEHAVIOR_MAX: FMOD_SOUNDGROUP_BEHAVIOR = 3;
pub const FMOD_SOUNDGROUP_BEHAVIOR_FMOD_SOUNDGROUP_BEHAVIOR_FORCEINT: FMOD_SOUNDGROUP_BEHAVIOR = 65536;
pub type FMOD_SOUNDGROUP_BEHAVIOR = ::core::ffi::c_uint;
pub const FMOD_CHANNELCONTROL_CALLBACK_TYPE_FMOD_CHANNELCONTROL_CALLBACK_END: FMOD_CHANNELCONTROL_CALLBACK_TYPE = 0;
pub const FMOD_CHANNELCONTROL_CALLBACK_TYPE_FMOD_CHANNELCONTROL_CALLBACK_VIRTUALVOICE:
    FMOD_CHANNELCONTROL_CALLBACK_TYPE = 1;
pub const FMOD_CHANNELCONTROL_CALLBACK_TYPE_FMOD_CHANNELCONTROL_CALLBACK_SYNCPOINT: FMOD_CHANNELCONTROL_CALLBACK_TYPE =
    2;
pub const FMOD_CHANNELCONTROL_CALLBACK_TYPE_FMOD_CHANNELCONTROL_CALLBACK_OCCLUSION: FMOD_CHANNELCONTROL_CALLBACK_TYPE =
    3;
pub const FMOD_CHANNELCONTROL_CALLBACK_TYPE_FMOD_CHANNELCONTROL_CALLBACK_MAX: FMOD_CHANNELCONTROL_CALLBACK_TYPE = 4;
pub const FMOD_CHANNELCONTROL_CALLBACK_TYPE_FMOD_CHANNELCONTROL_CALLBACK_FORCEINT: FMOD_CHANNELCONTROL_CALLBACK_TYPE =
    65536;
pub type FMOD_CHANNELCONTROL_CALLBACK_TYPE = ::core::ffi::c_uint;
pub const FMOD_CHANNELCONTROL_DSP_INDEX_FMOD_CHANNELCONTROL_DSP_HEAD: FMOD_CHANNELCONTROL_DSP_INDEX = -1;
pub const FMOD_CHANNELCONTROL_DSP_INDEX_FMOD_CHANNELCONTROL_DSP_FADER: FMOD_CHANNELCONTROL_DSP_INDEX = -2;
pub const FMOD_CHANNELCONTROL_DSP_INDEX_FMOD_CHANNELCONTROL_DSP_TAIL: FMOD_CHANNELCONTROL_DSP_INDEX = -3;
pub const FMOD_CHANNELCONTROL_DSP_INDEX_FMOD_CHANNELCONTROL_DSP_FORCEINT: FMOD_CHANNELCONTROL_DSP_INDEX = 65536;
pub type FMOD_CHANNELCONTROL_DSP_INDEX = ::core::ffi::c_int;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_NONE: FMOD_ERRORCALLBACK_INSTANCETYPE = 0;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_SYSTEM: FMOD_ERRORCALLBACK_INSTANCETYPE = 1;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_CHANNEL: FMOD_ERRORCALLBACK_INSTANCETYPE = 2;
...
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_SOUND: FMOD_ERRORCALLBACK_INSTANCETYPE = 5;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_SOUNDGROUP: FMOD_ERRORCALLBACK_INSTANCETYPE =
    6;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_DSP: FMOD_ERRORCALLBACK_INSTANCETYPE = 7;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_DSPCONNECTION:
    FMOD_ERRORCALLBACK_INSTANCETYPE = 8;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_GEOMETRY: FMOD_ERRORCALLBACK_INSTANCETYPE = 9;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_REVERB3D: FMOD_ERRORCALLBACK_INSTANCETYPE =
    10;
...
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_STUDIO_EVENTDESCRIPTION:
    FMOD_ERRORCALLBACK_INSTANCETYPE = 12;
...
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_STUDIO_PARAMETERINSTANCE:
    FMOD_ERRORCALLBACK_INSTANCETYPE = 14;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_STUDIO_BUS: FMOD_ERRORCALLBACK_INSTANCETYPE =
    15;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_STUDIO_VCA: FMOD_ERRORCALLBACK_INSTANCETYPE =
    16;
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_STUDIO_BANK: FMOD_ERRORCALLBACK_INSTANCETYPE =
    17;
...
pub const FMOD_ERRORCALLBACK_INSTANCETYPE_FMOD_ERRORCALLBACK_INSTANCETYPE_FORCEINT: FMOD_ERRORCALLBACK_INSTANCETYPE =
    65536;
...
pub const FMOD_DSPCONNECTION_TYPE_FMOD_DSPCONNECTION_TYPE_SEND_SIDECHAIN: FMOD_DSPCONNECTION_TYPE = 3;
...
pub type FMOD_SOUND_NONBLOCK_CALLBACK =
    ::std::option::Option<unsafe extern "C" fn(sound: *mut FMOD_SOUND, result: FMOD_RESULT) -> FMOD_RESULT>;
...
pub type FMOD_FILE_CLOSE_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(handle: *mut ::core::ffi::c_void, userdata: *mut ::core::ffi::c_void) -> FMOD_RESULT,
>;
...
pub type FMOD_FILE_ASYNCREAD_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(info: *mut FMOD_ASYNCREADINFO, userdata: *mut ::core::ffi::c_void) -> FMOD_RESULT,
>;
...
pub type FMOD_MEMORY_FREE_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(ptr: *mut ::core::ffi::c_void, type_: FMOD_MEMORY_TYPE, sourcestr: *const ::core::ffi::c_char),
>;
pub type FMOD_3D_ROLLOFF_CALLBACK =
    ::std::option::Option<unsafe extern "C" fn(channelcontrol: *mut FMOD_CHANNELCONTROL, distance: f32) -> f32>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: FMOD_ASYNCREADINFO::handle"][::std::mem::offset_of!(FMOD_ASYNCREADINFO, handle) - 0usize];
    ["Offset of field: FMOD_ASYNCREADINFO::offset"][::std::mem::offset_of!(FMOD_ASYNCREADINFO, offset) - 8usize];
    ["Offset of field: FMOD_ASYNCREADINFO::sizebytes"][::std::mem::offset_of!(FMOD_ASYNCREADINFO, sizebytes) - 12usize];
    ["Offset of field: FMOD_ASYNCREADINFO::priority"][::std::mem::offset_of!(FMOD_ASYNCREADINFO, priority) - 16usize];
    ["Offset of field: FMOD_ASYNCREADINFO::userdata"][::std::mem::offset_of!(FMOD_ASYNCREADINFO, userdata) - 24usize];
    ["Offset of field: FMOD_ASYNCREADINFO::buffer"][::std::mem::offset_of!(FMOD_ASYNCREADINFO, buffer) - 32usize];
    ["Offset of field: FMOD_ASYNCREADINFO::bytesread"][::std::mem::offset_of!(FMOD_ASYNCREADINFO, bytesread) - 40usize];
    ["Offset of field: FMOD_ASYNCREADINFO::done"][::std::mem::offset_of!(FMOD_ASYNCREADINFO, done) - 48usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: FMOD_3D_ATTRIBUTES::position"][::std::mem::offset_of!(FMOD_3D_ATTRIBUTES, position) - 0usize];
    ["Offset of field: FMOD_3D_ATTRIBUTES::velocity"][::std::mem::offset_of!(FMOD_3D_ATTRIBUTES, velocity) - 12usize];
    ["Offset of field: FMOD_3D_ATTRIBUTES::forward"][::std::mem::offset_of!(FMOD_3D_ATTRIBUTES, forward) - 24usize];
    ["Offset of field: FMOD_3D_ATTRIBUTES::up"][::std::mem::offset_of!(FMOD_3D_ATTRIBUTES, up) - 36usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: FMOD_PLUGINLIST::type_"][::std::mem::offset_of!(FMOD_PLUGINLIST, type_) - 0usize];
    ["Offset of field: FMOD_PLUGINLIST::description"][::std::mem::offset_of!(FMOD_PLUGINLIST, description) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Alignment of FMOD_ADVANCEDSETTINGS"][::std::mem::align_of::<FMOD_ADVANCEDSETTINGS>() - 8usize];
    ["Offset of field: FMOD_ADVANCEDSETTINGS::cbSize"][::std::mem::offset_of!(FMOD_ADVANCEDSETTINGS, cbSize) - 0usize];
...
const _: () = {
    ...
    ["Alignment of FMOD_CREATESOUNDEXINFO"][::std::mem::align_of::<FMOD_CREATESOUNDEXINFO>() - 8usize];
...
const _: () = {
    ...
    ["Alignment of FMOD_REVERB_PROPERTIES"][::std::mem::align_of::<FMOD_REVERB_PROPERTIES>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of FMOD_ERRORCALLBACK_INFO"][::std::mem::align_of::<FMOD_ERRORCALLBACK_INFO>() - 8usize];
...
const _: () = {
    ...
    ["Offset of field: FMOD_CPU_USAGE::stream"][::std::mem::offset_of!(FMOD_CPU_USAGE, stream) - 4usize];
    ["Offset of field: FMOD_CPU_USAGE::geometry"][::std::mem::offset_of!(FMOD_CPU_USAGE, geometry) - 8usize];
    ["Offset of field: FMOD_CPU_USAGE::update"][::std::mem::offset_of!(FMOD_CPU_USAGE, update) - 12usize];
    ["Offset of field: FMOD_CPU_USAGE::convolution1"][::std::mem::offset_of!(FMOD_CPU_USAGE, convolution1) - 16usize];
    ["Offset of field: FMOD_CPU_USAGE::convolution2"][::std::mem::offset_of!(FMOD_CPU_USAGE, convolution2) - 20usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_DATA_PARAMETER_INFO"][::std::mem::size_of::<FMOD_DSP_DATA_PARAMETER_INFO>() - 16usize];
    ["Alignment of FMOD_DSP_DATA_PARAMETER_INFO"][::std::mem::align_of::<FMOD_DSP_DATA_PARAMETER_INFO>() - 8usize];
...
pub type FMOD_CODEC_FREE_FUNC = ::std::option::Option<
    unsafe extern "C" fn(ptr: *mut ::core::ffi::c_void, file: *const ::core::ffi::c_char, line: ::core::ffi::c_int),
>;
...
pub type FMOD_CODEC_FILE_TELL_FUNC = ::std::option::Option<
    unsafe extern "C" fn(codec_state: *mut FMOD_CODEC_STATE, pos: *mut ::core::ffi::c_uint) -> FMOD_RESULT,
>;
pub type FMOD_CODEC_FILE_SIZE_FUNC = ::std::option::Option<
    unsafe extern "C" fn(codec_state: *mut FMOD_CODEC_STATE, size: *mut ::core::ffi::c_uint) -> FMOD_RESULT,
>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Alignment of FMOD_CODEC_DESCRIPTION"][::std::mem::align_of::<FMOD_CODEC_DESCRIPTION>() - 8usize];
    ["Offset of field: FMOD_CODEC_DESCRIPTION::apiversion"]
        [::std::mem::offset_of!(FMOD_CODEC_DESCRIPTION, apiversion) - 0usize];
    ["Offset of field: FMOD_CODEC_DESCRIPTION::name"][::std::mem::offset_of!(FMOD_CODEC_DESCRIPTION, name) - 8usize];
    ...
    ["Offset of field: FMOD_CODEC_DESCRIPTION::open"][::std::mem::offset_of!(FMOD_CODEC_DESCRIPTION, open) - 32usize];
    ["Offset of field: FMOD_CODEC_DESCRIPTION::close"][::std::mem::offset_of!(FMOD_CODEC_DESCRIPTION, close) - 40usize];
    ["Offset of field: FMOD_CODEC_DESCRIPTION::read"][::std::mem::offset_of!(FMOD_CODEC_DESCRIPTION, read) - 48usize];
...
const _: () = {
    ...
    ["Alignment of FMOD_CODEC_WAVEFORMAT"][::std::mem::align_of::<FMOD_CODEC_WAVEFORMAT>() - 8usize];
    ["Offset of field: FMOD_CODEC_WAVEFORMAT::name"][::std::mem::offset_of!(FMOD_CODEC_WAVEFORMAT, name) - 0usize];
    ["Offset of field: FMOD_CODEC_WAVEFORMAT::format"][::std::mem::offset_of!(FMOD_CODEC_WAVEFORMAT, format) - 8usize];
    ...
    ["Offset of field: FMOD_CODEC_WAVEFORMAT::mode"][::std::mem::offset_of!(FMOD_CODEC_WAVEFORMAT, mode) - 40usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_CODEC_STATE_FUNCTIONS"][::std::mem::size_of::<FMOD_CODEC_STATE_FUNCTIONS>() - 64usize];
    ["Alignment of FMOD_CODEC_STATE_FUNCTIONS"][::std::mem::align_of::<FMOD_CODEC_STATE_FUNCTIONS>() - 8usize];
...
const _: () = {
    ...
    ["Offset of field: FMOD_CODEC_STATE::plugindata"][::std::mem::offset_of!(FMOD_CODEC_STATE, plugindata) - 0usize];
    ["Offset of field: FMOD_CODEC_STATE::waveformat"][::std::mem::offset_of!(FMOD_CODEC_STATE, waveformat) - 8usize];
    ["Offset of field: FMOD_CODEC_STATE::functions"][::std::mem::offset_of!(FMOD_CODEC_STATE, functions) - 16usize];
...
pub const FMOD_DSP_ECHO_DELAYCHANGEMODE_TYPE_FMOD_DSP_ECHO_DELAYCHANGEMODE_FADE: FMOD_DSP_ECHO_DELAYCHANGEMODE_TYPE = 0;
pub const FMOD_DSP_ECHO_DELAYCHANGEMODE_TYPE_FMOD_DSP_ECHO_DELAYCHANGEMODE_LERP: FMOD_DSP_ECHO_DELAYCHANGEMODE_TYPE = 1;
pub const FMOD_DSP_ECHO_DELAYCHANGEMODE_TYPE_FMOD_DSP_ECHO_DELAYCHANGEMODE_NONE: FMOD_DSP_ECHO_DELAYCHANGEMODE_TYPE = 2;
...
pub const FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE_FMOD_DSP_MULTIBAND_EQ_FILTER_DISABLED: FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE =
    0;
...
pub const FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE_FMOD_DSP_MULTIBAND_EQ_FILTER_LOWSHELF: FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE =
    7;
pub const FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE_FMOD_DSP_MULTIBAND_EQ_FILTER_HIGHSHELF: FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE =
    8;
pub const FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE_FMOD_DSP_MULTIBAND_EQ_FILTER_PEAKING: FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE = 9;
pub const FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE_FMOD_DSP_MULTIBAND_EQ_FILTER_BANDPASS: FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE =
    10;
pub const FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE_FMOD_DSP_MULTIBAND_EQ_FILTER_NOTCH: FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE = 11;
pub const FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE_FMOD_DSP_MULTIBAND_EQ_FILTER_ALLPASS: FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE =
    12;
...
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_LOWER_FREQUENCY: FMOD_DSP_MULTIBAND_DYNAMICS = 0;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_UPPER_FREQUENCY: FMOD_DSP_MULTIBAND_DYNAMICS = 1;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_LINKED: FMOD_DSP_MULTIBAND_DYNAMICS = 2;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_USE_SIDECHAIN: FMOD_DSP_MULTIBAND_DYNAMICS = 3;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_A_MODE: FMOD_DSP_MULTIBAND_DYNAMICS = 4;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_A_GAIN: FMOD_DSP_MULTIBAND_DYNAMICS = 5;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_A_THRESHOLD: FMOD_DSP_MULTIBAND_DYNAMICS = 6;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_A_RATIO: FMOD_DSP_MULTIBAND_DYNAMICS = 7;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_A_ATTACK: FMOD_DSP_MULTIBAND_DYNAMICS = 8;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_A_RELEASE: FMOD_DSP_MULTIBAND_DYNAMICS = 9;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_A_GAIN_MAKEUP: FMOD_DSP_MULTIBAND_DYNAMICS = 10;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_A_RESPONSE_DATA: FMOD_DSP_MULTIBAND_DYNAMICS = 11;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_B_MODE: FMOD_DSP_MULTIBAND_DYNAMICS = 12;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_B_GAIN: FMOD_DSP_MULTIBAND_DYNAMICS = 13;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_B_THRESHOLD: FMOD_DSP_MULTIBAND_DYNAMICS = 14;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_B_RATIO: FMOD_DSP_MULTIBAND_DYNAMICS = 15;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_B_ATTACK: FMOD_DSP_MULTIBAND_DYNAMICS = 16;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_B_RELEASE: FMOD_DSP_MULTIBAND_DYNAMICS = 17;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_B_GAIN_MAKEUP: FMOD_DSP_MULTIBAND_DYNAMICS = 18;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_B_RESPONSE_DATA: FMOD_DSP_MULTIBAND_DYNAMICS = 19;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_C_MODE: FMOD_DSP_MULTIBAND_DYNAMICS = 20;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_C_GAIN: FMOD_DSP_MULTIBAND_DYNAMICS = 21;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_C_THRESHOLD: FMOD_DSP_MULTIBAND_DYNAMICS = 22;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_C_RATIO: FMOD_DSP_MULTIBAND_DYNAMICS = 23;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_C_ATTACK: FMOD_DSP_MULTIBAND_DYNAMICS = 24;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_C_RELEASE: FMOD_DSP_MULTIBAND_DYNAMICS = 25;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_C_GAIN_MAKEUP: FMOD_DSP_MULTIBAND_DYNAMICS = 26;
pub const FMOD_DSP_MULTIBAND_DYNAMICS_FMOD_DSP_MULTIBAND_DYNAMICS_C_RESPONSE_DATA: FMOD_DSP_MULTIBAND_DYNAMICS = 27;
...
pub const FMOD_DSP_PAN_2D_STEREO_MODE_TYPE_FMOD_DSP_PAN_2D_STEREO_MODE_DISTRIBUTED: FMOD_DSP_PAN_2D_STEREO_MODE_TYPE =
    0;
pub const FMOD_DSP_PAN_2D_STEREO_MODE_TYPE_FMOD_DSP_PAN_2D_STEREO_MODE_DISCRETE: FMOD_DSP_PAN_2D_STEREO_MODE_TYPE = 1;
...
pub const FMOD_DSP_PAN_3D_ROLLOFF_TYPE_FMOD_DSP_PAN_3D_ROLLOFF_LINEARSQUARED: FMOD_DSP_PAN_3D_ROLLOFF_TYPE = 0;
pub const FMOD_DSP_PAN_3D_ROLLOFF_TYPE_FMOD_DSP_PAN_3D_ROLLOFF_LINEAR: FMOD_DSP_PAN_3D_ROLLOFF_TYPE = 1;
pub const FMOD_DSP_PAN_3D_ROLLOFF_TYPE_FMOD_DSP_PAN_3D_ROLLOFF_INVERSE: FMOD_DSP_PAN_3D_ROLLOFF_TYPE = 2;
pub const FMOD_DSP_PAN_3D_ROLLOFF_TYPE_FMOD_DSP_PAN_3D_ROLLOFF_INVERSETAPERED: FMOD_DSP_PAN_3D_ROLLOFF_TYPE = 3;
pub const FMOD_DSP_PAN_3D_ROLLOFF_TYPE_FMOD_DSP_PAN_3D_ROLLOFF_CUSTOM: FMOD_DSP_PAN_3D_ROLLOFF_TYPE = 4;
pub type FMOD_DSP_PAN_3D_ROLLOFF_TYPE = ::core::ffi::c_uint;
pub const FMOD_DSP_PAN_3D_EXTENT_MODE_TYPE_FMOD_DSP_PAN_3D_EXTENT_MODE_AUTO: FMOD_DSP_PAN_3D_EXTENT_MODE_TYPE = 0;
pub const FMOD_DSP_PAN_3D_EXTENT_MODE_TYPE_FMOD_DSP_PAN_3D_EXTENT_MODE_USER: FMOD_DSP_PAN_3D_EXTENT_MODE_TYPE = 1;
pub const FMOD_DSP_PAN_3D_EXTENT_MODE_TYPE_FMOD_DSP_PAN_3D_EXTENT_MODE_OFF: FMOD_DSP_PAN_3D_EXTENT_MODE_TYPE = 2;
...
pub const FMOD_DSP_LOUDNESS_METER_STATE_TYPE_FMOD_DSP_LOUDNESS_METER_STATE_PAUSED: FMOD_DSP_LOUDNESS_METER_STATE_TYPE =
    0;
...
const _: () = {
    ...
    ["Offset of field: FMOD_DSP_LOUDNESS_METER_INFO_TYPE::loudness10thpercentile"]
        [::std::mem::offset_of!(FMOD_DSP_LOUDNESS_METER_INFO_TYPE, loudness10thpercentile) - 12usize];
    ["Offset of field: FMOD_DSP_LOUDNESS_METER_INFO_TYPE::loudness95thpercentile"]
        [::std::mem::offset_of!(FMOD_DSP_LOUDNESS_METER_INFO_TYPE, loudness95thpercentile) - 16usize];
    ...
    ["Offset of field: FMOD_DSP_LOUDNESS_METER_INFO_TYPE::maxmomentaryloudness"]
        [::std::mem::offset_of!(FMOD_DSP_LOUDNESS_METER_INFO_TYPE, maxmomentaryloudness) - 288usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const FMOD_DSP_CONVOLUTION_REVERB_FMOD_DSP_CONVOLUTION_REVERB_PARAM_IR: FMOD_DSP_CONVOLUTION_REVERB = 0;
pub const FMOD_DSP_CONVOLUTION_REVERB_FMOD_DSP_CONVOLUTION_REVERB_PARAM_WET: FMOD_DSP_CONVOLUTION_REVERB = 1;
pub const FMOD_DSP_CONVOLUTION_REVERB_FMOD_DSP_CONVOLUTION_REVERB_PARAM_DRY: FMOD_DSP_CONVOLUTION_REVERB = 2;
pub const FMOD_DSP_CONVOLUTION_REVERB_FMOD_DSP_CONVOLUTION_REVERB_PARAM_LINKED: FMOD_DSP_CONVOLUTION_REVERB = 3;
pub type FMOD_DSP_CONVOLUTION_REVERB = ::core::ffi::c_uint;
pub const FMOD_DSP_CHANNELMIX_OUTPUT_FMOD_DSP_CHANNELMIX_OUTPUT_DEFAULT: FMOD_DSP_CHANNELMIX_OUTPUT = 0;
pub const FMOD_DSP_CHANNELMIX_OUTPUT_FMOD_DSP_CHANNELMIX_OUTPUT_ALLMONO: FMOD_DSP_CHANNELMIX_OUTPUT = 1;
pub const FMOD_DSP_CHANNELMIX_OUTPUT_FMOD_DSP_CHANNELMIX_OUTPUT_ALLSTEREO: FMOD_DSP_CHANNELMIX_OUTPUT = 2;
pub const FMOD_DSP_CHANNELMIX_OUTPUT_FMOD_DSP_CHANNELMIX_OUTPUT_ALLQUAD: FMOD_DSP_CHANNELMIX_OUTPUT = 3;
pub const FMOD_DSP_CHANNELMIX_OUTPUT_FMOD_DSP_CHANNELMIX_OUTPUT_ALL5POINT1: FMOD_DSP_CHANNELMIX_OUTPUT = 4;
pub const FMOD_DSP_CHANNELMIX_OUTPUT_FMOD_DSP_CHANNELMIX_OUTPUT_ALL7POINT1: FMOD_DSP_CHANNELMIX_OUTPUT = 5;
pub const FMOD_DSP_CHANNELMIX_OUTPUT_FMOD_DSP_CHANNELMIX_OUTPUT_ALLLFE: FMOD_DSP_CHANNELMIX_OUTPUT = 6;
pub const FMOD_DSP_CHANNELMIX_OUTPUT_FMOD_DSP_CHANNELMIX_OUTPUT_ALL7POINT1POINT4: FMOD_DSP_CHANNELMIX_OUTPUT = 7;
...
pub const FMOD_DSP_TRANSCEIVER_SPEAKERMODE_FMOD_DSP_TRANSCEIVER_SPEAKERMODE_AUTO: FMOD_DSP_TRANSCEIVER_SPEAKERMODE = -1;
pub const FMOD_DSP_TRANSCEIVER_SPEAKERMODE_FMOD_DSP_TRANSCEIVER_SPEAKERMODE_MONO: FMOD_DSP_TRANSCEIVER_SPEAKERMODE = 0;
pub const FMOD_DSP_TRANSCEIVER_SPEAKERMODE_FMOD_DSP_TRANSCEIVER_SPEAKERMODE_STEREO: FMOD_DSP_TRANSCEIVER_SPEAKERMODE =
    1;
pub const FMOD_DSP_TRANSCEIVER_SPEAKERMODE_FMOD_DSP_TRANSCEIVER_SPEAKERMODE_SURROUND: FMOD_DSP_TRANSCEIVER_SPEAKERMODE =
    2;
...
pub const FMOD_DSP_PAN_SURROUND_FLAGS_FMOD_DSP_PAN_SURROUND_DEFAULT: FMOD_DSP_PAN_SURROUND_FLAGS = 0;
pub const FMOD_DSP_PAN_SURROUND_FLAGS_FMOD_DSP_PAN_SURROUND_ROTATION_NOT_BIASED: FMOD_DSP_PAN_SURROUND_FLAGS = 1;
pub const FMOD_DSP_PAN_SURROUND_FLAGS_FMOD_DSP_PAN_SURROUND_FLAGS_FORCEINT: FMOD_DSP_PAN_SURROUND_FLAGS = 65536;
...
pub const FMOD_DSP_PARAMETER_FLOAT_MAPPING_TYPE_FMOD_DSP_PARAMETER_FLOAT_MAPPING_TYPE_PIECEWISE_LINEAR:
...
pub const FMOD_DSP_PARAMETER_DATA_TYPE_FMOD_DSP_PARAMETER_DATA_TYPE_USER: FMOD_DSP_PARAMETER_DATA_TYPE = 0;
pub const FMOD_DSP_PARAMETER_DATA_TYPE_FMOD_DSP_PARAMETER_DATA_TYPE_OVERALLGAIN: FMOD_DSP_PARAMETER_DATA_TYPE = -1;
pub const FMOD_DSP_PARAMETER_DATA_TYPE_FMOD_DSP_PARAMETER_DATA_TYPE_3DATTRIBUTES: FMOD_DSP_PARAMETER_DATA_TYPE = -2;
pub const FMOD_DSP_PARAMETER_DATA_TYPE_FMOD_DSP_PARAMETER_DATA_TYPE_SIDECHAIN: FMOD_DSP_PARAMETER_DATA_TYPE = -3;
pub const FMOD_DSP_PARAMETER_DATA_TYPE_FMOD_DSP_PARAMETER_DATA_TYPE_FFT: FMOD_DSP_PARAMETER_DATA_TYPE = -4;
pub const FMOD_DSP_PARAMETER_DATA_TYPE_FMOD_DSP_PARAMETER_DATA_TYPE_3DATTRIBUTES_MULTI: FMOD_DSP_PARAMETER_DATA_TYPE =
    -5;
pub const FMOD_DSP_PARAMETER_DATA_TYPE_FMOD_DSP_PARAMETER_DATA_TYPE_ATTENUATION_RANGE: FMOD_DSP_PARAMETER_DATA_TYPE =
    -6;
pub const FMOD_DSP_PARAMETER_DATA_TYPE_FMOD_DSP_PARAMETER_DATA_TYPE_DYNAMIC_RESPONSE: FMOD_DSP_PARAMETER_DATA_TYPE = -7;
...
pub type FMOD_DSP_SETPARAM_FLOAT_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(dsp_state: *mut FMOD_DSP_STATE, index: ::core::ffi::c_int, value: f32) -> FMOD_RESULT,
>;
...
pub type FMOD_DSP_SETPARAM_BOOL_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(dsp_state: *mut FMOD_DSP_STATE, index: ::core::ffi::c_int, value: FMOD_BOOL) -> FMOD_RESULT,
>;
...
pub type FMOD_DSP_GETSAMPLERATE_FUNC = ::std::option::Option<
    unsafe extern "C" fn(dsp_state: *mut FMOD_DSP_STATE, rate: *mut ::core::ffi::c_int) -> FMOD_RESULT,
>;
pub type FMOD_DSP_GETBLOCKSIZE_FUNC = ::std::option::Option<
    unsafe extern "C" fn(dsp_state: *mut FMOD_DSP_STATE, blocksize: *mut ::core::ffi::c_uint) -> FMOD_RESULT,
>;
...
pub type FMOD_DSP_GETUSERDATA_FUNC = ::std::option::Option<
    unsafe extern "C" fn(dsp_state: *mut FMOD_DSP_STATE, userdata: *mut *mut ::core::ffi::c_void) -> FMOD_RESULT,
>;
...
const _: () = {
    ...
    ["Alignment of FMOD_DSP_BUFFER_ARRAY"][::std::mem::align_of::<FMOD_DSP_BUFFER_ARRAY>() - 8usize];
...
const _: () = {
    ...
    ["Offset of field: FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR::numpoints"]
        [::std::mem::offset_of!(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR, numpoints) - 0usize];
    ["Offset of field: FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR::pointparamvalues"]
        [::std::mem::offset_of!(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR, pointparamvalues) - 8usize];
    ["Offset of field: FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR::pointpositions"]
        [::std::mem::offset_of!(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR, pointpositions) - 16usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_PARAMETER_FLOAT_MAPPING"][::std::mem::size_of::<FMOD_DSP_PARAMETER_FLOAT_MAPPING>() - 32usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_PARAMETER_DESC_FLOAT"][::std::mem::size_of::<FMOD_DSP_PARAMETER_DESC_FLOAT>() - 48usize];
    ["Alignment of FMOD_DSP_PARAMETER_DESC_FLOAT"][::std::mem::align_of::<FMOD_DSP_PARAMETER_DESC_FLOAT>() - 8usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_PARAMETER_DESC_INT"][::std::mem::size_of::<FMOD_DSP_PARAMETER_DESC_INT>() - 24usize];
    ["Alignment of FMOD_DSP_PARAMETER_DESC_INT"][::std::mem::align_of::<FMOD_DSP_PARAMETER_DESC_INT>() - 8usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_PARAMETER_DESC_BOOL"][::std::mem::size_of::<FMOD_DSP_PARAMETER_DESC_BOOL>() - 16usize];
    ["Alignment of FMOD_DSP_PARAMETER_DESC_BOOL"][::std::mem::align_of::<FMOD_DSP_PARAMETER_DESC_BOOL>() - 8usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_PARAMETER_DESC_DATA"][::std::mem::size_of::<FMOD_DSP_PARAMETER_DESC_DATA>() - 4usize];
    ["Alignment of FMOD_DSP_PARAMETER_DESC_DATA"][::std::mem::align_of::<FMOD_DSP_PARAMETER_DESC_DATA>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of FMOD_DSP_PARAMETER_DESC"][::std::mem::align_of::<FMOD_DSP_PARAMETER_DESC>() - 8usize];
    ["Offset of field: FMOD_DSP_PARAMETER_DESC::type_"]
        [::std::mem::offset_of!(FMOD_DSP_PARAMETER_DESC, type_) - 0usize];
    ["Offset of field: FMOD_DSP_PARAMETER_DESC::name"][::std::mem::offset_of!(FMOD_DSP_PARAMETER_DESC, name) - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_PARAMETER_OVERALLGAIN"][::std::mem::size_of::<FMOD_DSP_PARAMETER_OVERALLGAIN>() - 8usize];
    ["Alignment of FMOD_DSP_PARAMETER_OVERALLGAIN"][::std::mem::align_of::<FMOD_DSP_PARAMETER_OVERALLGAIN>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_PARAMETER_3DATTRIBUTES"][::std::mem::size_of::<FMOD_DSP_PARAMETER_3DATTRIBUTES>() - 96usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_PARAMETER_SIDECHAIN"][::std::mem::size_of::<FMOD_DSP_PARAMETER_SIDECHAIN>() - 4usize];
    ["Alignment of FMOD_DSP_PARAMETER_SIDECHAIN"][::std::mem::align_of::<FMOD_DSP_PARAMETER_SIDECHAIN>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of FMOD_DSP_PARAMETER_FFT"][::std::mem::align_of::<FMOD_DSP_PARAMETER_FFT>() - 8usize];
...
const _: () = {
    ...
    ["Offset of field: FMOD_DSP_DESCRIPTION::name"][::std::mem::offset_of!(FMOD_DSP_DESCRIPTION, name) - 4usize];
    ["Offset of field: FMOD_DSP_DESCRIPTION::version"][::std::mem::offset_of!(FMOD_DSP_DESCRIPTION, version) - 36usize];
    ...
    ["Offset of field: FMOD_DSP_DESCRIPTION::create"][::std::mem::offset_of!(FMOD_DSP_DESCRIPTION, create) - 48usize];
    ["Offset of field: FMOD_DSP_DESCRIPTION::release"][::std::mem::offset_of!(FMOD_DSP_DESCRIPTION, release) - 56usize];
    ["Offset of field: FMOD_DSP_DESCRIPTION::reset"][::std::mem::offset_of!(FMOD_DSP_DESCRIPTION, reset) - 64usize];
    ["Offset of field: FMOD_DSP_DESCRIPTION::read"][::std::mem::offset_of!(FMOD_DSP_DESCRIPTION, read) - 72usize];
    ["Offset of field: FMOD_DSP_DESCRIPTION::process"][::std::mem::offset_of!(FMOD_DSP_DESCRIPTION, process) - 80usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_STATE_DFT_FUNCTIONS"][::std::mem::size_of::<FMOD_DSP_STATE_DFT_FUNCTIONS>() - 16usize];
    ["Alignment of FMOD_DSP_STATE_DFT_FUNCTIONS"][::std::mem::align_of::<FMOD_DSP_STATE_DFT_FUNCTIONS>() - 8usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_STATE_PAN_FUNCTIONS"][::std::mem::size_of::<FMOD_DSP_STATE_PAN_FUNCTIONS>() - 48usize];
    ["Alignment of FMOD_DSP_STATE_PAN_FUNCTIONS"][::std::mem::align_of::<FMOD_DSP_STATE_PAN_FUNCTIONS>() - 8usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_DSP_STATE_FUNCTIONS"][::std::mem::size_of::<FMOD_DSP_STATE_FUNCTIONS>() - 96usize];
    ["Alignment of FMOD_DSP_STATE_FUNCTIONS"][::std::mem::align_of::<FMOD_DSP_STATE_FUNCTIONS>() - 8usize];
    ...
    ["Offset of field: FMOD_DSP_STATE_FUNCTIONS::dft"][::std::mem::offset_of!(FMOD_DSP_STATE_FUNCTIONS, dft) - 40usize];
    ["Offset of field: FMOD_DSP_STATE_FUNCTIONS::pan"][::std::mem::offset_of!(FMOD_DSP_STATE_FUNCTIONS, pan) - 48usize];
    ...
    ["Offset of field: FMOD_DSP_STATE_FUNCTIONS::log"][::std::mem::offset_of!(FMOD_DSP_STATE_FUNCTIONS, log) - 80usize];
...
const _: () = {
    ...
    ["Offset of field: FMOD_DSP_STATE::instance"][::std::mem::offset_of!(FMOD_DSP_STATE, instance) - 0usize];
    ["Offset of field: FMOD_DSP_STATE::plugindata"][::std::mem::offset_of!(FMOD_DSP_STATE, plugindata) - 8usize];
    ["Offset of field: FMOD_DSP_STATE::channelmask"][::std::mem::offset_of!(FMOD_DSP_STATE, channelmask) - 16usize];
    ["Offset of field: FMOD_DSP_STATE::source_speakermode"]
        [::std::mem::offset_of!(FMOD_DSP_STATE, source_speakermode) - 20usize];
    ["Offset of field: FMOD_DSP_STATE::sidechaindata"][::std::mem::offset_of!(FMOD_DSP_STATE, sidechaindata) - 24usize];
    ["Offset of field: FMOD_DSP_STATE::sidechainchannels"]
        [::std::mem::offset_of!(FMOD_DSP_STATE, sidechainchannels) - 32usize];
    ["Offset of field: FMOD_DSP_STATE::functions"][::std::mem::offset_of!(FMOD_DSP_STATE, functions) - 40usize];
    ["Offset of field: FMOD_DSP_STATE::systemobject"][::std::mem::offset_of!(FMOD_DSP_STATE, systemobject) - 48usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Alignment of FMOD_DSP_METERING_INFO"][::std::mem::align_of::<FMOD_DSP_METERING_INFO>() - 4usize];
...
pub type FMOD_OUTPUT_GETNUMDRIVERS_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(output_state: *mut FMOD_OUTPUT_STATE, numdrivers: *mut ::core::ffi::c_int) -> FMOD_RESULT,
>;
...
pub type FMOD_OUTPUT_START_CALLBACK =
    ::std::option::Option<unsafe extern "C" fn(output_state: *mut FMOD_OUTPUT_STATE) -> FMOD_RESULT>;
...
pub type FMOD_OUTPUT_GETHANDLE_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(output_state: *mut FMOD_OUTPUT_STATE, handle: *mut *mut ::core::ffi::c_void) -> FMOD_RESULT,
>;
...
pub type FMOD_OUTPUT_OBJECT3DALLOC_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(output_state: *mut FMOD_OUTPUT_STATE, object3d: *mut *mut ::core::ffi::c_void) -> FMOD_RESULT,
>;
pub type FMOD_OUTPUT_OBJECT3DFREE_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(output_state: *mut FMOD_OUTPUT_STATE, object3d: *mut ::core::ffi::c_void) -> FMOD_RESULT,
>;
...
pub type FMOD_OUTPUT_CLOSEPORT_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(output_state: *mut FMOD_OUTPUT_STATE, portId: ::core::ffi::c_int) -> FMOD_RESULT,
>;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_OUTPUT_DESCRIPTION"][::std::mem::size_of::<FMOD_OUTPUT_DESCRIPTION>() - 152usize];
    ["Alignment of FMOD_OUTPUT_DESCRIPTION"][::std::mem::align_of::<FMOD_OUTPUT_DESCRIPTION>() - 8usize];
    ["Offset of field: FMOD_OUTPUT_DESCRIPTION::apiversion"]
        [::std::mem::offset_of!(FMOD_OUTPUT_DESCRIPTION, apiversion) - 0usize];
    ["Offset of field: FMOD_OUTPUT_DESCRIPTION::name"][::std::mem::offset_of!(FMOD_OUTPUT_DESCRIPTION, name) - 8usize];
    ...
    ["Offset of field: FMOD_OUTPUT_DESCRIPTION::init"][::std::mem::offset_of!(FMOD_OUTPUT_DESCRIPTION, init) - 40usize];
    ["Offset of field: FMOD_OUTPUT_DESCRIPTION::start"]
        [::std::mem::offset_of!(FMOD_OUTPUT_DESCRIPTION, start) - 48usize];
    ["Offset of field: FMOD_OUTPUT_DESCRIPTION::stop"][::std::mem::offset_of!(FMOD_OUTPUT_DESCRIPTION, stop) - 56usize];
...
const _: () = {
    ...
    ["Offset of field: FMOD_OUTPUT_STATE::plugindata"][::std::mem::offset_of!(FMOD_OUTPUT_STATE, plugindata) - 0usize];
    ["Offset of field: FMOD_OUTPUT_STATE::readfrommixer"]
        [::std::mem::offset_of!(FMOD_OUTPUT_STATE, readfrommixer) - 8usize];
    ["Offset of field: FMOD_OUTPUT_STATE::alloc"][::std::mem::offset_of!(FMOD_OUTPUT_STATE, alloc) - 16usize];
    ["Offset of field: FMOD_OUTPUT_STATE::free"][::std::mem::offset_of!(FMOD_OUTPUT_STATE, free) - 24usize];
    ["Offset of field: FMOD_OUTPUT_STATE::log"][::std::mem::offset_of!(FMOD_OUTPUT_STATE, log) - 32usize];
    ["Offset of field: FMOD_OUTPUT_STATE::copyport"][::std::mem::offset_of!(FMOD_OUTPUT_STATE, copyport) - 40usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FMOD_OUTPUT_OBJECT3DINFO"][::std::mem::size_of::<FMOD_OUTPUT_OBJECT3DINFO>() - 40usize];
    ["Alignment of FMOD_OUTPUT_OBJECT3DINFO"][::std::mem::align_of::<FMOD_OUTPUT_OBJECT3DINFO>() - 8usize];
...
unsafe extern "C" {
    pub fn FMOD_System_Create(system: *mut *mut FMOD_SYSTEM, headerversion: ::core::ffi::c_uint) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_GetOutput(system: *mut FMOD_SYSTEM, output: *mut FMOD_OUTPUTTYPE) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_System_GetNumDrivers(system: *mut FMOD_SYSTEM, numdrivers: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_SetDriver(system: *mut FMOD_SYSTEM, driver: ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_System_GetDriver(system: *mut FMOD_SYSTEM, driver: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_SetPluginPath(system: *mut FMOD_SYSTEM, path: *const ::core::ffi::c_char) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_UnloadPlugin(system: *mut FMOD_SYSTEM, handle: ::core::ffi::c_uint) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_SetOutputByPlugin(system: *mut FMOD_SYSTEM, handle: ::core::ffi::c_uint) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_System_GetOutputByPlugin(system: *mut FMOD_SYSTEM, handle: *mut ::core::ffi::c_uint) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_Set3DNumListeners(system: *mut FMOD_SYSTEM, numlisteners: ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_GetOutputHandle(system: *mut FMOD_SYSTEM, handle: *mut *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_GetCPUUsage(system: *mut FMOD_SYSTEM, usage: *mut FMOD_CPU_USAGE) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_CreateReverb3D(system: *mut FMOD_SYSTEM, reverb: *mut *mut FMOD_REVERB3D) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_SetGeometrySettings(system: *mut FMOD_SYSTEM, maxworldsize: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_System_GetGeometrySettings(system: *mut FMOD_SYSTEM, maxworldsize: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_SetNetworkProxy(system: *mut FMOD_SYSTEM, proxy: *const ::core::ffi::c_char) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_System_SetNetworkTimeout(system: *mut FMOD_SYSTEM, timeout: ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_System_GetNetworkTimeout(system: *mut FMOD_SYSTEM, timeout: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_System_SetUserData(system: *mut FMOD_SYSTEM, userdata: *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_System_GetUserData(system: *mut FMOD_SYSTEM, userdata: *mut *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Sound_Release(sound: *mut FMOD_SOUND) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Sound_GetSystemObject(sound: *mut FMOD_SOUND, system: *mut *mut FMOD_SYSTEM) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Sound_SetDefaults(sound: *mut FMOD_SOUND, frequency: f32, priority: ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Sound_Set3DMinMaxDistance(sound: *mut FMOD_SOUND, min: f32, max: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Sound_Get3DMinMaxDistance(sound: *mut FMOD_SOUND, min: *mut f32, max: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Sound_GetSubSoundParent(sound: *mut FMOD_SOUND, parentsound: *mut *mut FMOD_SOUND) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Sound_GetNumSubSounds(sound: *mut FMOD_SOUND, numsubsounds: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Sound_SetSoundGroup(sound: *mut FMOD_SOUND, soundgroup: *mut FMOD_SOUNDGROUP) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Sound_GetSoundGroup(sound: *mut FMOD_SOUND, soundgroup: *mut *mut FMOD_SOUNDGROUP) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Sound_GetNumSyncPoints(sound: *mut FMOD_SOUND, numsyncpoints: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Sound_DeleteSyncPoint(sound: *mut FMOD_SOUND, point: *mut FMOD_SYNCPOINT) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Sound_SetLoopCount(sound: *mut FMOD_SOUND, loopcount: ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Sound_GetLoopCount(sound: *mut FMOD_SOUND, loopcount: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Sound_GetMusicNumChannels(sound: *mut FMOD_SOUND, numchannels: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Sound_SetUserData(sound: *mut FMOD_SOUND, userdata: *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Sound_GetUserData(sound: *mut FMOD_SOUND, userdata: *mut *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_GetSystemObject(channel: *mut FMOD_CHANNEL, system: *mut *mut FMOD_SYSTEM) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_GetPaused(channel: *mut FMOD_CHANNEL, paused: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_GetVolumeRamp(channel: *mut FMOD_CHANNEL, ramp: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_GetAudibility(channel: *mut FMOD_CHANNEL, audibility: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_SetCallback(channel: *mut FMOD_CHANNEL, callback: FMOD_CHANNELCONTROL_CALLBACK) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_IsPlaying(channel: *mut FMOD_CHANNEL, isplaying: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_GetNumDSPs(channel: *mut FMOD_CHANNEL, numdsps: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_Set3DConeOrientation(channel: *mut FMOD_CHANNEL, orientation: *mut FMOD_VECTOR) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_Get3DConeOrientation(channel: *mut FMOD_CHANNEL, orientation: *mut FMOD_VECTOR) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_Get3DDopplerLevel(channel: *mut FMOD_CHANNEL, level: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_SetUserData(channel: *mut FMOD_CHANNEL, userdata: *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_GetUserData(channel: *mut FMOD_CHANNEL, userdata: *mut *mut ::core::ffi::c_void)
        -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_GetFrequency(channel: *mut FMOD_CHANNEL, frequency: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_SetPriority(channel: *mut FMOD_CHANNEL, priority: ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_GetPriority(channel: *mut FMOD_CHANNEL, priority: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_SetLoopCount(channel: *mut FMOD_CHANNEL, loopcount: ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_GetLoopCount(channel: *mut FMOD_CHANNEL, loopcount: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Channel_IsVirtual(channel: *mut FMOD_CHANNEL, isvirtual: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_GetCurrentSound(channel: *mut FMOD_CHANNEL, sound: *mut *mut FMOD_SOUND) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Channel_GetIndex(channel: *mut FMOD_CHANNEL, index: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_SetPaused(channelgroup: *mut FMOD_CHANNELGROUP, paused: FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_GetPaused(channelgroup: *mut FMOD_CHANNELGROUP, paused: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_SetVolume(channelgroup: *mut FMOD_CHANNELGROUP, volume: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_GetVolume(channelgroup: *mut FMOD_CHANNELGROUP, volume: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_SetVolumeRamp(channelgroup: *mut FMOD_CHANNELGROUP, ramp: FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_GetVolumeRamp(channelgroup: *mut FMOD_CHANNELGROUP, ramp: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_GetAudibility(channelgroup: *mut FMOD_CHANNELGROUP, audibility: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_SetPitch(channelgroup: *mut FMOD_CHANNELGROUP, pitch: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_GetPitch(channelgroup: *mut FMOD_CHANNELGROUP, pitch: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_SetMute(channelgroup: *mut FMOD_CHANNELGROUP, mute: FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_GetMute(channelgroup: *mut FMOD_CHANNELGROUP, mute: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_SetLowPassGain(channelgroup: *mut FMOD_CHANNELGROUP, gain: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_GetLowPassGain(channelgroup: *mut FMOD_CHANNELGROUP, gain: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_SetMode(channelgroup: *mut FMOD_CHANNELGROUP, mode: FMOD_MODE) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_GetMode(channelgroup: *mut FMOD_CHANNELGROUP, mode: *mut FMOD_MODE) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_IsPlaying(channelgroup: *mut FMOD_CHANNELGROUP, isplaying: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_RemoveDSP(channelgroup: *mut FMOD_CHANNELGROUP, dsp: *mut FMOD_DSP) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_Set3DSpread(channelgroup: *mut FMOD_CHANNELGROUP, angle: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_Get3DSpread(channelgroup: *mut FMOD_CHANNELGROUP, angle: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_Set3DLevel(channelgroup: *mut FMOD_CHANNELGROUP, level: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_Get3DLevel(channelgroup: *mut FMOD_CHANNELGROUP, level: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_Set3DDopplerLevel(channelgroup: *mut FMOD_CHANNELGROUP, level: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_ChannelGroup_Get3DDopplerLevel(channelgroup: *mut FMOD_CHANNELGROUP, level: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_SoundGroup_SetMuteFadeSpeed(soundgroup: *mut FMOD_SOUNDGROUP, speed: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_SoundGroup_GetMuteFadeSpeed(soundgroup: *mut FMOD_SOUNDGROUP, speed: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_SoundGroup_SetVolume(soundgroup: *mut FMOD_SOUNDGROUP, volume: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_SoundGroup_GetVolume(soundgroup: *mut FMOD_SOUNDGROUP, volume: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_DSP_GetSystemObject(dsp: *mut FMOD_DSP, system: *mut *mut FMOD_SYSTEM) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_DSP_DisconnectAll(dsp: *mut FMOD_DSP, inputs: FMOD_BOOL, outputs: FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_DSP_GetNumInputs(dsp: *mut FMOD_DSP, numinputs: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_DSP_GetNumOutputs(dsp: *mut FMOD_DSP, numoutputs: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_DSP_SetWetDryMix(dsp: *mut FMOD_DSP, prewet: f32, postwet: f32, dry: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_DSP_GetWetDryMix(dsp: *mut FMOD_DSP, prewet: *mut f32, postwet: *mut f32, dry: *mut f32)
        -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_DSP_SetParameterFloat(dsp: *mut FMOD_DSP, index: ::core::ffi::c_int, value: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_DSP_SetParameterBool(dsp: *mut FMOD_DSP, index: ::core::ffi::c_int, value: FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_DSP_GetNumParameters(dsp: *mut FMOD_DSP, numparams: *mut ::core::ffi::c_int) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_DSP_SetUserData(dsp: *mut FMOD_DSP, userdata: *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_DSP_GetUserData(dsp: *mut FMOD_DSP, userdata: *mut *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_DSPConnection_SetMix(dspconnection: *mut FMOD_DSPCONNECTION, volume: f32) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_DSPConnection_GetMix(dspconnection: *mut FMOD_DSPCONNECTION, volume: *mut f32) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Geometry_GetActive(geometry: *mut FMOD_GEOMETRY, active: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Geometry_SetPosition(geometry: *mut FMOD_GEOMETRY, position: *const FMOD_VECTOR) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Geometry_GetPosition(geometry: *mut FMOD_GEOMETRY, position: *mut FMOD_VECTOR) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Geometry_SetScale(geometry: *mut FMOD_GEOMETRY, scale: *const FMOD_VECTOR) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Geometry_GetScale(geometry: *mut FMOD_GEOMETRY, scale: *mut FMOD_VECTOR) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Geometry_SetUserData(geometry: *mut FMOD_GEOMETRY, userdata: *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FMOD_Reverb3D_GetActive(reverb3d: *mut FMOD_REVERB3D, active: *mut FMOD_BOOL) -> FMOD_RESULT;
}
unsafe extern "C" {
    pub fn FMOD_Reverb3D_SetUserData(reverb3d: *mut FMOD_REVERB3D, userdata: *mut ::core::ffi::c_void) -> FMOD_RESULT;
}
unsafe extern "C" {

...
fn main() {
    let bindings = bindgen::Builder::default()
        .header("src-fmod/fmod/headers/fmod.h")
        .header("src-fmod/fmod/headers/fmod_common.h")
        .header("src-fmod/fmod/headers/fmod_errors.h")
    ...
    let out_path = PathBuf::from("src-fmod/src/ffi/fmod_sys.rs");
    bindings
    ...
    println!("Generated bindings to src-fmod/src/ffi/fmod_sys.rs");
    println!("Run from workspace root with: cargo run --bin generate_bindings");
}
